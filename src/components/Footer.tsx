    ...
    <footer className="bg-gray-900 text-white py-12"> {/* Enclose everything in a <footer> tag */}
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* ... other divs */}
           <div>
              ...
              IJAGI Bringing together pioneering research in generative AI, from theoretical advancements to real-world applications.
              </p>
            </div>
            <div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; 2025 IJAGI. All rights reserved.</p>
        </div>
      </div>
